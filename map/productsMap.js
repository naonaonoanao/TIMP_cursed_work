...
export function drawProductsMap() {
    ...
    var polyline1 = L.polyline([circleTeam1.getLatLng(), marker1.getLatLng(), circleTeam1.getLatLng(), marker2.getLatLng(), circleTeam1.getLatLng(), marker3.getLatLng(), circleTeam1.getLatLng(), marker4.getLatLng(), circleTeam1.getLatLng(), marker5.getLatLng(), circleTeam1.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polyline2 = L.polyline([circleTeam1.getLatLng(), marker6.getLatLng(), circleTeam1.getLatLng(), marker7.getLatLng(), circleTeam1.getLatLng(), marker8.getLatLng(), circleTeam1.getLatLng(), marker9.getLatLng(), circleTeam1.getLatLng(), marker.getLatLng(), circleTeam1.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    var polyline10 = L.polyline([circleTeam10.getLatLng(), marker10.getLatLng(), circleTeam10.getLatLng(), marker20.getLatLng(), circleTeam10.getLatLng(), marker30.getLatLng(), circleTeam10.getLatLng(), marker40.getLatLng(), circleTeam10.getLatLng(), marker50.getLatLng(), circleTeam10.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polyline20 = L.polyline([circleTeam10.getLatLng(), marker60.getLatLng(), circleTeam10.getLatLng(), marker70.getLatLng(), circleTeam10.getLatLng(), marker80.getLatLng(), circleTeam10.getLatLng(), marker90.getLatLng(), circleTeam10.getLatLng(), marker0.getLatLng(), circleTeam10.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    var text = L.marker([51.35, -1], {
        icon: createIconWithText('')
    });
    var text0 = L.marker([52.35, 0], {
        icon: createIconWithText('')
    });
    var text3 = L.marker([49.95, -1], {
        icon: createIconWithText('')
    });
    var text4 = L.marker([49.95, 2], {
        icon: createIconWithText('')
    });
    var text5 = L.marker([51.55, 3], {
        icon: createIconWithText('')
    });
    ...
    cityCircle1.bindTooltip("Mobile", {
    ...
    var polyline11 = L.polyline([circleTeam11.getLatLng(), marker11.getLatLng(), circleTeam11.getLatLng(), marker21.getLatLng(), circleTeam11.getLatLng(), marker31.getLatLng(), circleTeam11.getLatLng(), marker41.getLatLng(), circleTeam11.getLatLng(), marker51.getLatLng(), circleTeam11.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polyline21 = L.polyline([circleTeam11.getLatLng(), marker61.getLatLng(), circleTeam11.getLatLng(), marker71.getLatLng(), circleTeam11.getLatLng(), marker81.getLatLng(), circleTeam11.getLatLng(), marker91.getLatLng(), circleTeam11.getLatLng(), marker101.getLatLng(), circleTeam11.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    var polyline12 = L.polyline([circleTeam12.getLatLng(), marker12.getLatLng(), circleTeam12.getLatLng(), marker22.getLatLng(), circleTeam12.getLatLng(), marker32.getLatLng(), circleTeam12.getLatLng(), marker42.getLatLng(), circleTeam12.getLatLng(), marker52.getLatLng(), circleTeam12.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polyline22 = L.polyline([circleTeam12.getLatLng(), marker62.getLatLng(), circleTeam12.getLatLng(), marker72.getLatLng(), circleTeam12.getLatLng(), marker82.getLatLng(), circleTeam12.getLatLng(), marker92.getLatLng(), circleTeam12.getLatLng(), marker202.getLatLng(), circleTeam12.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    var polyline13 = L.polyline([circleTeam13.getLatLng(), marker13.getLatLng(), circleTeam13.getLatLng(), marker23.getLatLng(), circleTeam13.getLatLng(), marker33.getLatLng(), circleTeam13.getLatLng(), marker43.getLatLng(), circleTeam13.getLatLng(), marker53.getLatLng(), circleTeam13.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polyline23 = L.polyline([circleTeam13.getLatLng(), marker63.getLatLng(), circleTeam13.getLatLng(), marker73.getLatLng(), circleTeam13.getLatLng(), marker83.getLatLng(), circleTeam13.getLatLng(), marker93.getLatLng(), circleTeam13.getLatLng(), marker303.getLatLng(), circleTeam13.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    var polylineCityTeam = L.polyline([cityCircle1.getLatLng(), circleTeam1.getLatLng(), cityCircle1.getLatLng(), circleTeam10.getLatLng(), cityCircle1.getLatLng(), circleTeam11.getLatLng(), cityCircle1.getLatLng(), circleTeam12.getLatLng(), cityCircle1.getLatLng(), circleTeam13.getLatLng(), cityCircle1.getLatLng()], {
        color: '#dda187',
        weight: 7
    }).addTo(map);
    ...
    // Добавляем маркеры в группу кластеров
    var markerWeb1 = L.marker([51.25 + 2, -0.5 + 14], {
        icon: customIcon
    });
    var markerWeb2 = L.marker([51.4 + 2, -0.63 + 14], {
        icon: customIcon
    });
    var markerWeb3 = L.marker([51.56 + 2, -0.68 + 14], {
        icon: customIcon
    });
    var markerWeb4 = L.marker([51.593 + 2, -0.3 + 14], {
        icon: customIcon
    });
    var markerWeb5 = L.marker([51.95 + 2, -0.34 + 14], {
        icon: customIcon
    });
    var markerWeb6 = L.marker([51.762 + 2, 0.03 + 14], {
        icon: customIcon
    });
    var markerWeb7 = L.marker([51.87 + 2, 0.3 + 14], {
        icon: customIcon
    });
    var markerWeb8 = L.marker([51.7 + 2, 0.4 + 14], {
        icon: customIcon
    });
    var markerWeb9 = L.marker([51.3 + 2, 0.4 + 14], {
        icon: customIcon
    });
    var markerWeb = L.marker([51.2 + 2, -0.06 + 14], {
        icon: customIcon
    });

    // Создание круга с центром в координатах [широта, долгота]
    var circleTeamWeb1 = L.circle([51.51 + 2, 0 + 14], {
        radius: 4000, // радиус круга в метрах
        color: '#e32e56', // цвет границы круга
        fillColor: '#ff335f', // цвет заливки круга
        fillOpacity: 1, // прозрачность заливки круга (от 0 до 1)
    ...
    var polylineWeb1 = L.polyline([circleTeamWeb1.getLatLng(), markerWeb1.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb2.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb3.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb4.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb5.getLatLng(), circleTeamWeb1.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polylineWeb2 = L.polyline([circleTeamWeb1.getLatLng(), markerWeb6.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb7.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb8.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb9.getLatLng(), circleTeamWeb1.getLatLng(), markerWeb.getLatLng(), circleTeamWeb1.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    // Добавляем маркеры в группу кластеров
    var markerWeb10 = L.marker([52.25 + 2, 0.5 + 14], {
        icon: customIcon
    });
    var markerWeb20 = L.marker([52.4 + 2, 1.03 + 14], {
        icon: customIcon
    });
    var markerWeb30 = L.marker([52.56 + 2, 0.68 + 14], {
        icon: customIcon
    });
    var markerWeb40 = L.marker([52.993 + 2, 0.4 + 14], {
        icon: customIcon
    });
    var markerWeb50 = L.marker([52.95 + 2, 0.94 + 14], {
        icon: customIcon
    });
    var markerWeb60 = L.marker([52.762 + 2, 1.03 + 14], {
        icon: customIcon
    });
    var markerWeb70 = L.marker([52.87 + 2, 1.3 + 14], {
        icon: customIcon
    });
    var markerWeb80 = L.marker([52.7 + 2, 1.4 + 14], {
        icon: customIcon
    });
    var markerWeb90 = L.marker([52.3 + 2, 1.4 + 14], {
        icon: customIcon
    });
    var markerWeb0 = L.marker([52.2 + 2, 1.06 + 14], {
        icon: customIcon
    });

    // Создание круга с центром в координатах [широта, долгота]
    var circleTeamWeb10 = L.circle([52.51 + 2, 1 + 14], {
        radius: 4000, // радиус круга в метрах
        color: '#e32e56', // цвет границы круга
        fillColor: '#ff335f', // цвет заливки круга
        fillOpacity: 1, // прозрачность заливки круга (от 0 до 1)
    ...
    var polylineWeb10 = L.polyline([circleTeamWeb10.getLatLng(), markerWeb10.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb20.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb30.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb40.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb50.getLatLng(), circleTeamWeb10.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polylineWeb20 = L.polyline([circleTeamWeb10.getLatLng(), markerWeb60.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb70.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb80.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb90.getLatLng(), circleTeamWeb10.getLatLng(), markerWeb0.getLatLng(), circleTeamWeb10.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    // Создаем маркер с DivIcon
    var textWeb = L.marker([51.35 + 2, -1 + 14], {
        icon: createIconWithText('')
    });
    var textWeb0 = L.marker([52.35 + 2, 0 + 14], {
        icon: createIconWithText('')
    });
    var textWeb3 = L.marker([49.95 + 2, -1 + 14], {
        icon: createIconWithText('')
    });
    var textWeb4 = L.marker([49.95 + 2, 2 + 14], {
        icon: createIconWithText('')
    });
    var textWeb5 = L.marker([51.55 + 2, 3 + 14], {
        icon: createIconWithText('')
    });
    ...
    // Создание круга с центром в координатах [широта, долгота]
    var cityCircleWeb1 = L.circle([51.51 + 2, 1.5 + 14], {
        radius: 25000, // радиус круга в метрах
        color: '#d51e46', // цвет границы круга
        fillColor: '#d51e46', // цвет заливки круга
        fillOpacity: 1, // Возможность кликать по метке
    ...
    // Добавление всплывающей подсказки с текстом внутрь круга
    cityCircleWeb1.bindTooltip("Web", {
        permanent: true, // Постоянная подсказка
        direction: 'center', // Выравнивание текста по центру
        className: 'circle-tooltip' // CSS-класс для стилизации подсказки
    });
    ...
    // Добавляем маркеры в группу кластеров
    var markerWeb11 = L.marker([50.85 + 2, -0.5 + 14], {
        icon: customIcon
    });
    var markerWeb21 = L.marker([50.0 + 2, -0.63 + 14], {
        icon: customIcon
    });
    var markerWeb31 = L.marker([50.16 + 2, -0.68 + 14], {
        icon: customIcon
    });
    var markerWeb41 = L.marker([50.193 + 2, -0.3 + 14], {
        icon: customIcon
    });
    var markerWeb51 = L.marker([50.55 + 2, -0.34 + 14], {
        icon: customIcon
    });
    var markerWeb61 = L.marker([50.362 + 2, 0.03 + 14], {
        icon: customIcon
    });
    var markerWeb71 = L.marker([50.47 + 2, 0.3 + 14], {
        icon: customIcon
    });
    var markerWeb81 = L.marker([50.3 + 2, 0.4 + 14], {
        icon: customIcon
    });
    var markerWeb91 = L.marker([49.9 + 2, 0.4 + 14], {
        icon: customIcon
    });
    var markerWeb101 = L.marker([49.7 + 2, -0.06 + 14], {
        icon: customIcon
    });

    // Создание круга с центром в координатах [широта, долгота]
    var circleTeamWeb11 = L.circle([50.11 + 2, 0 + 14], {
        radius: 4000, // радиус круга в метрах
        color: '#e32e56', // цвет границы круга
        fillColor: '#ff335f', // цвет заливки круга
        fillOpacity: 1, // прозрачность заливки круга (от 0 до 1)
    ...
    var polylineWeb11 = L.polyline([circleTeamWeb11.getLatLng(), markerWeb11.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb21.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb31.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb41.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb51.getLatLng(), circleTeamWeb11.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polylineWeb21 = L.polyline([circleTeamWeb11.getLatLng(), markerWeb61.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb71.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb81.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb91.getLatLng(), circleTeamWeb11.getLatLng(), markerWeb101.getLatLng(), circleTeamWeb11.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    // Добавляем маркеры в группу кластеров
    var markerWeb12 = L.marker([50.85 + 2, 1.5 + 14], {
        icon: newCustomIcon
    });
    var markerWeb22 = L.marker([50.0 + 2, 2.63 + 14], {
        icon: newCustomIcon
    });
    var markerWeb32 = L.marker([50.16 + 2, 1.68 + 14], {
        icon: newCustomIcon
    });
    var markerWeb42 = L.marker([50.193 + 2, 2.3 + 14], {
        icon: newCustomIcon
    });
    var markerWeb52 = L.marker([50.55 + 2, 1.34 + 14], {
        icon: newCustomIcon
    });
    var markerWeb62 = L.marker([50.362 + 2, 2.03 + 14], {
        icon: newCustomIcon
    });
    var markerWeb72 = L.marker([50.47 + 2, 2.3 + 14], {
        icon: newCustomIcon
    });
    var markerWeb82 = L.marker([50.3 + 2, 2.4 + 14], {
        icon: newCustomIcon
    });
    var markerWeb92 = L.marker([49.9 + 2, 2.4 + 14], {
        icon: newCustomIcon
    });
    var markerWeb202 = L.marker([49.7 + 2, 1.06 + 14], {
        icon: newCustomIcon
    });

    // Создание круга с центром в координатах [широта, долгота]
    var circleTeamWeb12 = L.circle([50.11 + 2, 2 + 14], {
        radius: 4000, // радиус круга в метрах
        color: '#e32e56', // цвет границы круга
        fillColor: '#ff335f', // цвет заливки круга
        fillOpacity: 1, // прозрачность заливки круга (от 0 до 1)
    ...
    var polylineWeb12 = L.polyline([circleTeamWeb12.getLatLng(), markerWeb12.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb22.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb32.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb42.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb52.getLatLng(), circleTeamWeb12.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polylineWeb22 = L.polyline([circleTeamWeb12.getLatLng(), markerWeb62.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb72.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb82.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb92.getLatLng(), circleTeamWeb12.getLatLng(), markerWeb202.getLatLng(), circleTeamWeb12.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    // Добавляем маркеры в группу кластеров
    var markerWeb13 = L.marker([52.85 + 2, 3.5 + 14], {
        icon: newCustomIcon
    });
    var markerWeb23 = L.marker([52.0 + 2, 4.93 + 14], {
        icon: newCustomIcon
    });
    var markerWeb33 = L.marker([52.16 + 2, 4.38 + 14], {
        icon: newCustomIcon
    });
    var markerWeb43 = L.marker([52.193 + 2, 3.3 + 14], {
        icon: newCustomIcon
    });
    var markerWeb53 = L.marker([52.55 + 2, 3.84 + 14], {
        icon: newCustomIcon
    });
    var markerWeb63 = L.marker([52.362 + 2, 4.53 + 14], {
        icon: newCustomIcon
    });
    var markerWeb73 = L.marker([52.47 + 2, 3.3 + 14], {
        icon: newCustomIcon
    });
    var markerWeb83 = L.marker([51.7 + 2, 4.4 + 14], {
        icon: newCustomIcon
    });
    var markerWeb93 = L.marker([51.9 + 2, 3 + 14], {
        icon: newCustomIcon
    });
    var markerWeb303 = L.marker([51.7 + 2, 3.56 + 14], {
        icon: newCustomIcon
    });

    // Создание круга с центром в координатах [широта, долгота]
    var circleTeamWeb13 = L.circle([52.11 + 2, 4 + 14], {
        radius: 4000, // радиус круга в метрах
        color: '#e32e56', // цвет границы круга
        fillColor: '#ff335f', // цвет заливки круга
        fillOpacity: 1, // прозрачность заливки круга (от 0 до 1)
    ...
    var polylineWeb13 = L.polyline([circleTeamWeb13.getLatLng(), markerWeb13.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb23.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb33.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb43.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb53.getLatLng(), circleTeamWeb13.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    var polylineWeb23 = L.polyline([circleTeamWeb13.getLatLng(), markerWeb63.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb73.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb83.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb93.getLatLng(), circleTeamWeb13.getLatLng(), markerWeb303.getLatLng(), circleTeamWeb13.getLatLng()], {
        color: '#f7edbd'
    }).addTo(map);
    ...
    var polylineCityTeamWeb = L.polyline([cityCircleWeb1.getLatLng(), circleTeamWeb1.getLatLng(), cityCircleWeb1.getLatLng(), circleTeamWeb10.getLatLng(), cityCircleWeb1.getLatLng(), circleTeamWeb11.getLatLng(), cityCircleWeb1.getLatLng(), circleTeamWeb12.getLatLng(), cityCircleWeb1.getLatLng(), circleTeamWeb13.getLatLng(), cityCircleWeb1.getLatLng()], {
        color: '#dda187',
        weight: 7
    }).addTo(map);
